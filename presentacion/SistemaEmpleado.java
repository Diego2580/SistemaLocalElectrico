 ...
 * @author diego
 */
public class SistemaEmpleado extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        tbListUser.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 204, 0)));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 0)), "Datos del Empleado", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 14), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblDateUser1, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(txtNameUser, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(txtLastnameUser, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(321, 321, 321)
                                        .addComponent(txtNumIdUser, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(lblEmailUser, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(lblDateUser))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtDateUser, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(txtEmailUser, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                .addComponent(btnDeleteUser, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(cmbRol, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(btnRegisterUser, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(49, 49, 49)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(checkActive, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
                .addGap(37, 37, 37)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(464, 464, 464)
                        .addComponent(lblListUserRegister, javax.swing.GroupLayout.DEFAULT_SIZE, 995, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
...
private Empleado GenerarDatosEmpleado(){
    ...
    String cargo = "Sin cargo"; // valor fijo temporal
    ...
    try {
        ...
        nuevoEmpleado = new Empleado(nombre, apellido, numId, correo,
                fechaNacimiento, rol, cargo, LocalDate.now(), activo);
...
// En el método ActualizarTablaRegistro(), modifica el bucle para incluir rol y activo:
private void ActualizarTablaRegistro(){
    ...
    for (Persona personaActual : this.listadoPersonas) {
        // Verifica si es una instancia de Empleado para obtener rol y estado
        if(personaActual instanceof Empleado) {
            Empleado emp = (Empleado) personaActual;
            Object[] fila = new Object[] {
                ...
                emp.getRol(),       // Agregar rol
                emp.isActivo() ? "Sí" : "No"  // Agregar estado activo
            };
...
// En el método LlenarFormularioDesdeTabla(), agrega la recuperación de rol y activo:
private void LlenarFormularioDesdeTabla() {
    ...
    if (filaSeleccionada >= 0) {
        ...
        Persona personaSeleccionada = this.listadoPersonas.get(filaSeleccionada);
        
        if(personaSeleccionada instanceof Empleado) {
            Empleado emp = (Empleado) personaSeleccionada;
            
            this.txtNameUser.setText(emp.getNombre());
            this.txtLastnameUser.setText(emp.getApellido());
            this.txtNumIdUser.setText(emp.getNumIdentificacion());
            this.txtEmailUser.setText(emp.getCorreo());
            this.txtDateUser.setText(emp.getFechaNacimiento().toString());
            
            // Establecer el rol en el ComboBox
            this.cmbRol.setSelectedItem(emp.getRol());
            
            // Establecer el estado activo en el CheckBox
            this.checkActive.setSelected(emp.isActivo());
        }
    }
}
